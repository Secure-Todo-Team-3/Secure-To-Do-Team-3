...
resource "aws_cloudfront_distribution" "frontend_cdn" {
  ...
  # Add ordered cache behaviors for JavaScript files
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = aws_cloudfront_response_headers_policy.js_headers.id

  }

  # Add ordered cache behaviors for HTML files
  ...
  ordered_cache_behavior {
    ...
    response_headers_policy_id = aws_cloudfront_response_headers_policy.html_headers.id
...
# Add response headers policy for JavaScript files

resource "aws_cloudfront_response_headers_policy" "js_headers" {

  name    = "${var.name_prefix}-js-headers"

  comment = "Response headers policy for JavaScript files"
...
# Add response headers policy for HTML files

resource "aws_cloudfront_response_headers_policy" "html_headers" {

  name    = "${var.name_prefix}-html-headers"

  comment = "Response headers policy for HTML files"
